...
#define APP_CFGINT_SDI12SENSOR_PROTO_STACK_SIZE         (OSThread::STACK_MINIMAL_SIZE + 120)
#define APP_CFGINT_SDI12SENSOR_DACQ_STACK_SIZE          (OSThread::STACK_MINIMAL_SIZE + 80)
#define APP_CFGINT_SDI12SENSOR_PERIODIC_STACK_SIZE      (OSThread::STACK_MINIMAL_SIZE + 80)
