...
DeviceCharacterI2C::DeviceCharacterI2C(unsigned char *pTxBuf,
      ...
      rxLWM)
  {
    ...
    OSDeviceDebug::putString("DeviceCharacterI2C()=");
...
OSEvent_t DeviceCharacterI2C::implGetOpenEvent(void)
  {
...
bool DeviceCharacterI2C::implIsConnected() const
  {
    return true;
  }
...
bool DeviceCharacterI2C::implCanWrite(void)
  {
    return !m_txBuf.isFull();
  }

OSEvent_t DeviceCharacterI2C::implGetWriteEvent(void)
  {
    return (OSEvent_t)&m_txBuf;
  }

int DeviceCharacterI2C::implWriteByte(unsigned char b)
  {
    m_txBuf.put(b);
...
int DeviceCharacterI2C::implFlush(void)
  {
...
void DeviceCharacterI2C::interruptServiceRoutine(void)
  {
...
bool DeviceCharacterI2C::implCanRead()
  {
    return !m_rxBuf.isEmpty();
  }

int DeviceCharacterI2C::implAvailableRead()
  {
    return !m_rxBuf.length();
  }

OSEvent_t DeviceCharacterI2C::implGetReadEvent(void)
  {
    return (OSEvent_t)&m_rxBuf;
  }

int DeviceCharacterI2C::implReadByte(void)
  {
    return m_rxBuf.get();
  }
...
inline void DeviceCharacterI2C::interruptTxEnable(void)
  {
    ;
  }

inline void DeviceCharacterI2C::interruptTxDisable(void)
  {
    ;
  }

inline unsigned char DeviceCharacterI2C::portRead(void)
  {
    return TWDR;
  }

inline void DeviceCharacterI2C::portWrite(unsigned char b)
  {
    TWDR = b;
  }
...
extern "C" void TWI_vect( void ) __attribute__( ( signal, naked ) );
