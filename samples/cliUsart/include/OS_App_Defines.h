...
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_RX_PIN  (5)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_TX_PIN  (6)
...
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_RX_PIN  (51)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_TX_PIN  (52)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_GPIO_FUNCTION (1)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_DOUBLE_SPEED (true)
