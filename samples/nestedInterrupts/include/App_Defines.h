...
#define APP_CFGINT_TASKBLINKNESTED_TICKS        (OS_CFGINT_TICK_RATE_HZ * 7)
...
//#define APP_EXCLUDE_NESTEDINTERRUPT_NAKEDISR
//#define APP_ISR_ACTION_BUSYWAIT
//#define APP_EXCLUDE_TASKBLINKNESTED_ISRACTION
...
#define APP_CFGREG_TASKBLINKNESTED_TIMER                (AVR32_TC1)
#define APP_CFGINT_TASKBLINKNESTED_TIMERCHANNEL         (0)
#define APP_CFGINT_TASKBLINKNESTED_TIMERIRQID           (AVR32_TC1_IRQ0)
#define APP_CFGINT_TASKBLINKNESTED_TIMERIRQLEVEL        (1)
#define APP_CFGINT_TASKBLINKNESTED_TIMERCLOCKSELECT     (3)
#define APP_CFGINT_TASKBLINKNESTED_TIMERPRESCALLER      (4)

#define APP_CFGINT_TASKBLINKNESTED_EVENT                (0x1234)

#define APP_CFGINT_TASKBLINK_LEDBIT                     APP_CONFIG_LED1
#define APP_CFGINT_TASKBLINKNESTED_LEDBIT               APP_CONFIG_LED2

#define APP_CFGREG_TASKBLINKNESTED_ISRLEDPORTCONFIG     OS_CONFIG_ACTIVE_LED_PORT_CONFIG
#define APP_CFGINT_TASKBLINKNESTED_ISRLEDBIT            APP_CONFIG_LED3

//#define APP_EXCLUDE_TASKBLINKNESTED_TASKMAIN_LED        (1)
