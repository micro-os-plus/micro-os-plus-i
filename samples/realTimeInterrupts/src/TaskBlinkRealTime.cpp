...
{
#if !defined(APP_EXCLUDE_TASKBLINKREALTIME_ISR_ACTION)

#if defined(APP_INCLUDE_TASKBLINKREALTIME_ISR_LED)
...
#if defined(APP_INCLUDE_TASKBLINKREALTIME_ISR_ACTION_BUSYWAIT)
...
#endif /* APP_EXCLUDE_TASKBLINKREALTIME_ISR_ACTION */
}
