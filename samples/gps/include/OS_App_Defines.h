...
#define OS_INCLUDE_OSDEVICECHARACTER_READMATCH          (1)
#define OS_INCLUDE_OSDEVICECHARACTER_TIMEOUTS           (1)
#define OS_INCLUDE_OSDEVICECHARACTER_SETBAUDRATE        (1)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_TXBUF_ARRAY_SIZE (200)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_RXBUF_ARRAY_SIZE (200)
