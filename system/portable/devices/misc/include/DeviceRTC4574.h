...
public:
  ...
  static unsigned char readBytes(unsigned char addr, unsigned char *pBuf,
      unsigned char len);
  static void writeBytes(unsigned char addr, unsigned char *pBuf,
      unsigned char len);
...
private:
  ...
  static void fconInit(void);
  static void fconHigh(void);
  static void fconLow(void);
