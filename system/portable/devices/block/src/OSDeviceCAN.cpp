...
OSDeviceCAN::~OSDeviceCAN()
{
  OSDeviceDebug::putDestructor_P(PSTR("OSDeviceCAN"), this);
}

void
OSDeviceCAN::init(unsigned char mode)
{
...
int
OSDeviceCAN::readPacket(CANPacket *p)
{
  bool flag;
  for (;;)
    {
...
int
OSDeviceCAN::availableRead(void)
{
...
int
OSDeviceCAN::writePacket(CANPacket *p)
{
  int c;
