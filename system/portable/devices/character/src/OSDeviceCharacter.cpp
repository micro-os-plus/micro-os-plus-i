...
OSEvent_t OSDeviceCharacter::implGetOpenEvent(void)
  {
    return (OSEvent_t)&m_openEvent;
  }

OSEvent_t OSDeviceCharacter::implGetWriteEvent(void)
  {
    return (OSEvent_t)&m_writeEvent;
  }

OSEvent_t OSDeviceCharacter::implGetReadEvent(void)
  {
    return (OSEvent_t)&m_openEvent;
  }

bool OSDeviceCharacter::isConnected(void) const
  {
    bool flag;
...
bool OSDeviceCharacter::implIsConnected() const
  {
...
int OSDeviceCharacter::open(void)
  {
...
int OSDeviceCharacter::close(void)
  {
...
bool OSDeviceCharacter::isOpened(void) const
  {
    return m_isOpened;
  }
...
int OSDeviceCharacter::writeByte(unsigned char b)
  {
...
int OSDeviceCharacter::readByte(void)
  {
...
int OSDeviceCharacter::availableRead(void)
  {
    int c;
    OSScheduler::criticalEnter();
      {
...
int OSDeviceCharacter::overflow(int c)
  {
...
int OSDeviceCharacter::showmanyc(void)
  {
    return availableRead();
  }

int OSDeviceCharacter::underflow(void)
  {
    int r;
    r = readByte();
...
int OSDeviceCharacter::sync(void)
  {
    return flush();
  }
