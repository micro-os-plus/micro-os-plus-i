...
private:
  ...
  static void specificCdcInterruptServiceRoutine(void);

  static bool specificCdcProcessReadRequest(unsigned char type,
      unsigned char request);
  static void specificCdcEndpointInit(unsigned char confNum);
  static bool specificCdcGetDescriptor(unsigned char type, unsigned char index);

  void cdcGetLineCoding(void);
  void cdcSetLineCoding(void);
  void cdcSetControlLineState(void);
