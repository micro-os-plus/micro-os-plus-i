...
#if !defined(OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_TXBUF_ARRAY_SIZE)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_TXBUF_ARRAY_SIZE      (32)
#endif /* !defined(OS_CFGINT_DEVICECHARACTERBUFFEREDUSART0_TXBUF_ARRAY_SIZE) */

#if !defined(OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_RXBUF_ARRAY_SIZE)
#define OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_RXBUF_ARRAY_SIZE      (32)
#endif /* !defined(OS_CFGINT_DEVICECHARACTERBUFFEREDUSART1_RXBUF_ARRAY_SIZE) */
