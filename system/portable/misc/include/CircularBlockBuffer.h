...
inline bool
CircularBlockBuffer::isEmpty(void)
{
  return (m_len == 0);
}

inline bool
CircularBlockBuffer::isFull(void)
{
  return (m_len == m_szBlks);
}

inline bool
CircularBlockBuffer::isAboveHighWM(void)
{
  return (m_len > m_highWM);
}

inline bool
CircularBlockBuffer::isBelowLowWM(void)
{
  return (m_len < m_lowWM);
}

inline unsigned short
CircularBlockBuffer::length(void)
{
  return m_len;
}

inline unsigned short
CircularBlockBuffer::size(void)
{
  return m_szBlks;
}
