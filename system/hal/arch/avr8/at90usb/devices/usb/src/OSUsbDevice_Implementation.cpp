...
void OSUsbDeviceImpl::interruptComServiceRoutine(void)
  {
    OSUsbLed::toggle();
...
void OSUsbDeviceImpl::interruptGenServiceRoutine(void)
  {
    OSUsbLed::toggle();
    ...
    if (OSUsbDeviceImpl::Is_usb_sof() && OSUsbDeviceImpl::Is_sof_interrupt_enabled() )
      {
...
// @return status
//
unsigned char OSUsbDeviceImpl::usb_init_device(void)
  {
...
bool OSUsbDeviceImpl::usb_configure_endpoint(unsigned char num, unsigned char type,
    unsigned char dir, unsigned char size, unsigned char bank,
    unsigned char nyet)
  {
    OSUsbDeviceImpl::endpointSelect(num);
    return OSUsbDeviceImpl::usb_config_ep((type<<6) |(nyet<<1) |(dir), (size<<4)
        | (bank<<2));
  }
...
//
bool OSUsbDeviceImpl::usb_config_ep(unsigned char config0, unsigned char config1)
  {
...
// @return none
//
void OSUsbDeviceImpl::usb_start_device(void)
  {
    //PORTD |= _BV(PORTD7);
 ...
 */
unsigned short OSUsbDeviceImpl::readWord(void)
  {
    unsigned short w;
 ...
 */
unsigned long OSUsbDeviceImpl::readLong(void)
  {
    unsigned long l;
 ...
 */
void OSUsbDeviceImpl::writeWord(unsigned short w)
  {
 ...
 */
void OSUsbDeviceImpl::writeLong(unsigned long l)
  {
 ...
 * GET_STATUS
 */
void OSUsbDeviceImpl::standardProcessRequest(void)
  {
 ...
 */
bool OSUsbDeviceImpl::specificProcessReadRequest(unsigned char type,
 ...
 */
void OSUsbDeviceImpl::specificEndpointInit(unsigned char conf_nb)
  {
 ...
 */
bool OSUsbDeviceImpl::specificGetDescriptor(unsigned char type, unsigned char string)
  {
 ...
 */
void OSUsbDeviceImpl::usb_get_descriptor(void)
  {
 ...
 */
void OSUsbDeviceImpl::usb_get_configuration(void)
  {
    OSUsbDeviceImpl::Usb_ack_receive_setup();
 ...
 */
void OSUsbDeviceImpl::usb_set_address(void)
  {
    unsigned char addr;
 ...
 * number.
 */
void OSUsbDeviceImpl::usb_set_configuration(void)
  {
 ...
 */
void OSUsbDeviceImpl::usb_clear_feature(void)
  {
 ...
 */
void OSUsbDeviceImpl::usb_set_feature(void)
  {
    unsigned char wValue;
    unsigned char wIndex;
    unsigned char dummy;
 ...
 */
void OSUsbDeviceImpl::usb_get_status(void)
  {
    unsigned char wIndex;
    unsigned char dummy;
 ...
 */
void OSUsbDeviceImpl::usb_get_interface(void)
  {
    OSUsbDeviceImpl::Usb_enable_stall_handshake();
    OSUsbDeviceImpl::Usb_ack_receive_setup();
  }
 ...
 */
void OSUsbDeviceImpl::usb_set_interface(void)
  {
    OSUsbDeviceImpl::Usb_ack_receive_setup();
    OSUsbDeviceImpl::Usb_send_control_in(); // send a ZLP for STATUS phase
    while ( !OSUsbDeviceImpl::Is_usb_in_ready() )
 ...
 * - connection status
 */
void OSUsbDeviceImpl::usb_enum_var_init(void)
  {
 ...
 */
void OSUsbDeviceImpl::usb_set_return(unsigned char len, PGM_VOID_P pbuf)
  {
