...
//-----------------------------------------------------------------------------
inline void OSUsbDeviceImpl::Usb_set_configuration_action(void)
  {
    ;
  }

inline void OSUsbDeviceImpl::Usb_sof_action(void)
  {
    ; //sof_action();
  }

inline void OSUsbDeviceImpl::Usb_wake_up_action(void)
  {
    ;
  }

inline void OSUsbDeviceImpl::Usb_resume_action(void)
  {
    ;
  }

inline void OSUsbDeviceImpl::Usb_suspend_action(void)
  {
...
inline void OSUsbDeviceImpl::Usb_reset_action(void)
  {
    ;
  }

inline void OSUsbDeviceImpl::Usb_vbus_on_action(void)
  {
    ;
  }

inline void OSUsbDeviceImpl::Usb_vbus_off_action(void)
  {
    ;
  }
...
inline void OSUsbDeviceImpl::endpointSelect(unsigned char ep)
  {
    UENUM = ep;
  }

// reset the selected endpoint
inline void OSUsbDeviceImpl::endpointReset(unsigned char ep)
  {
    UERST = _BV(ep);
    UERST = 0;
  }
...
inline bool OSUsbDeviceImpl::isInterruptReceiveSetup(void)
  {
    return ((UEINTX & _BV(RXSTPI)) != 0) ? true : false;
  }

// test if SETUP interrupt enabled
inline bool OSUsbDeviceImpl::isInterruptReceiveSetupEnabled(void)
  {
    return ((UEIENX & _BV(RXSTPE)) != 0) ? true : false;
  }

// enable receive SETUP interrupt
inline void OSUsbDeviceImpl::interruptReceiveSetupEnable(void)
  {
    UEIENX |= _BV(RXSTPE);
  }

// test if receive OUT interrupt received
inline bool OSUsbDeviceImpl::isInterruptReceiveOut(void)
  {
    return (((UEINTX & _BV(RXOUTI))) != 0) ? true : false;
  }

// test if receive OUT interrupt enabled
inline bool OSUsbDeviceImpl::isInterruptReceiveOutEnabled(void)
  {
    return ((UEIENX & _BV(RXOUTE)) != 0) ? true : false;
  }

// ack receive OUT interrupt on control endpoint
inline void OSUsbDeviceImpl::interruptReceiveOutAck(void)
  {
    UEINTX &= ~_BV(RXOUTI);
  }

// enable receive OUT interrupt
inline void OSUsbDeviceImpl::interruptReceiveOutEnable(void)
  {
    UEIENX |= _BV(RXOUTE);
  }

// return FIFO byte for current endpoint
inline unsigned char OSUsbDeviceImpl::readByte(void)
  {
    return UEDATX;
  }

// write byte in FIFO for current endpoint
inline void OSUsbDeviceImpl::writeByte(unsigned char b)
  {
    UEDATX = b;
  }

// enables the STALL handshake for the next transaction
inline void OSUsbDeviceImpl::Usb_enable_stall_handshake(void)
  {
    UECONX |= _BV(STALLRQ);
  }

// acks receive SETUP interrupt
inline void OSUsbDeviceImpl::Usb_ack_receive_setup(void)
  {
    UEINTX &= ~_BV(RXSTPI);
  }

// Enable internal USB pads regulator
inline void OSUsbDeviceImpl::Usb_enable_regulator(void)
  {
    UHWCON |=_BV(UVREGE);
  }

// Disable external UID pin
inline void OSUsbDeviceImpl::Usb_disable_uid_pin(void)
  {
    UHWCON &= ~_BV(UIDE);
  }

// Disable external UID pin and force device mode
inline void OSUsbDeviceImpl::Usb_force_device_mode(void)
  {
...
inline void OSUsbDeviceImpl::Usb_disable(void)
  {
    USBCON &= ~(_BV(USBE) | _BV(OTGPADE));
  }

// Enable both USB interface and Vbus pad
inline void OSUsbDeviceImpl::Usb_enable(void)
  {
    USBCON |=(_BV(USBE) |_BV(OTGPADE));
  }

// select device mode
inline void OSUsbDeviceImpl::Usb_select_device(void)
  {
    USBCON &= ~_BV(HOST);
  }

// enable VBUS interrupt
inline void OSUsbDeviceImpl::Usb_enable_vbus_interrupt(void)
  {
    USBCON |= _BV(VBUSTE);
  }

// test if write endpoint enabled
inline bool OSUsbDeviceImpl::Is_usb_write_enabled(void)
  {
    return ((UEINTX & _BV(RWAL)) != 0) ? true : false;
  }

// test if transmit ready (same bit as allowed!)
inline bool OSUsbDeviceImpl::Is_usb_tx_ready(void)
  {
    return ((UEINTX & _BV(RWAL)) != 0) ? true : false;
  }

// send IN
inline void OSUsbDeviceImpl::Usb_send_in(void)
  {
    UEINTX &= ~_BV(FIFOCON);
  }

// return number of bytes in FIFO current endpoint (16 bits)
inline unsigned short OSUsbDeviceImpl::Usb_byte_counter(void)
  {
    return UEBCX;
  }

// clear FIFOCON bit
inline void OSUsbDeviceImpl::Usb_ack_fifocon(void)
  {
    UEINTX &= ~_BV(FIFOCON);
  }

inline bool OSUsbDeviceImpl::Is_usb_vbus_transition(void)
  {
    return ((USBINT & (1<<VBUSTI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_usb_vbus_interrupt_enabled(void)
  {
    return ((USBCON & (1<<VBUSTE)) != 0) ? true : false;
  }

inline void OSUsbDeviceImpl::Usb_ack_vbus_transition(void)
  {
    USBINT = ~_BV(VBUSTI);
  }

inline bool OSUsbDeviceImpl::Is_usb_vbus_high(void)
  {
    return ((USBSTA & (1<<VBUS)) != 0) ? true : false;
  }

// enable USB reset interrupt
inline void OSUsbDeviceImpl::Usb_enable_reset_interrupt(void)
  {
    UDIEN |= _BV(EORSTE);
  }

// test if read allowed on control endpoint
inline bool OSUsbDeviceImpl::Is_usb_read_control_enabled(void)
  {
    return ((UEINTX & _BV(TXINI)) != 0) ? true : false;
  }

// send IN on control endpoint
inline void OSUsbDeviceImpl::Usb_send_control_in(void)
  {
    UEINTX &= ~_BV(TXINI);
  }

// ack reveive OUT
inline void OSUsbDeviceImpl::Usb_ack_receive_out(void)
  {
    UEINTX &= ~_BV(RXOUTI);
...
// ack IN ready
inline void OSUsbDeviceImpl::Usb_ack_in_ready(void)
  {
    UEINTX &= ~_BV(TXINI);
    OSUsbDeviceImpl::Usb_ack_fifocon();
  }
...
// test if IN ready
inline bool OSUsbDeviceImpl::Is_usb_in_ready(void)
  {
    return ((UEINTX & _BV(TXINI)) != 0) ? true : false;
  }

// test if the current endpoint is enabled
inline bool OSUsbDeviceImpl::Is_usb_endpoint_enabled(void)
  {
    return ((UECONX & _BV(EPEN)) != 0) ? true : false;
  }

// disable the STALL handshake
inline void OSUsbDeviceImpl::Usb_disable_stall_handshake(void)
  {
    UECONX |= _BV(STALLRQC);
  }

// reset the data toggle sequence
inline void OSUsbDeviceImpl::Usb_reset_data_toggle(void)
  {
    UECONX |= _BV(RSTDT);
  }

// enable USB device address
inline void OSUsbDeviceImpl::Usb_enable_address(void)
  {
    UDADDR |= _BV(ADDEN);
  }

// set the USB device address
inline void OSUsbDeviceImpl::Usb_configure_address(unsigned char addr)
  {
    UDADDR = (UDADDR & _BV(ADDEN)) |(addr & MSK_UADD);
  }

inline void OSUsbDeviceImpl::Usb_send_event(unsigned char event)
  {
    g_usb_event |= (1<<event);
  }

// attache to USB bus
inline void OSUsbDeviceImpl::Usb_attach(void)
  {
    UDCON &= ~_BV(DETACH);
  }

// test if Start Of Frame occurs
inline bool OSUsbDeviceImpl::Is_usb_sof(void)
  {
    return ((UDINT & _BV(SOFI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_sof_interrupt_enabled(void)
  {
    return ((UDIEN & _BV(SOFE)) != 0) ? true : false;
  }

// ack Start Of Frame
inline void OSUsbDeviceImpl::Usb_ack_sof(void)
  {
    UDINT = ~_BV(SOFI);
  }

// test if Suspend state detected
inline bool OSUsbDeviceImpl::Is_usb_suspend(void)
  {
    return ((UDINT & _BV(SUSPI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_suspend_interrupt_enabled(void)
  {
    return ((UDIEN & _BV(SUSPE)) != 0) ? true : false;
  }

// ack Suspend
inline void OSUsbDeviceImpl::Usb_ack_suspend(void)
  {
    UDINT = ~_BV(SUSPI);
  }

// enable wake-up interrupt
inline void OSUsbDeviceImpl::Usb_enable_wake_up_interrupt(void)
  {
    UDIEN |= _BV(WAKEUPE);
  }

// ack wake-up
inline void OSUsbDeviceImpl::Usb_ack_wake_up(void)
  {
    UDINT = ~_BV(WAKEUPI);
  }

// Stop internal USB clock in interface(freeze the interface register)
inline void OSUsbDeviceImpl::Usb_freeze_clock(void)
  {
    USBCON |= _BV(FRZCLK);
  }

inline void OSUsbDeviceImpl::Usb_unfreeze_clock(void)
  {
    USBCON &= ~_BV(FRZCLK);
  }

// disable wake-up interrupt
inline void OSUsbDeviceImpl::Usb_disable_wake_up_interrupt(void)
  {
    UDIEN &= ~_BV(WAKEUPE);
  }

// ack resume
inline void OSUsbDeviceImpl::Usb_ack_resume(void)
  {
    UDINT = ~_BV(EORSMI);
  }

// disable resume interrupt
inline void OSUsbDeviceImpl::Usb_disable_resume_interrupt(void)
  {
    UDIEN &= ~_BV(EORSME);
  }

// ack USB reset
inline void OSUsbDeviceImpl::Usb_ack_reset(void)
  {
    UDINT = ~_BV(EORSTI);
  }

// test if wake-up occurs
inline bool OSUsbDeviceImpl::Is_usb_wake_up(void)
  {
    return ((UDINT & _BV(WAKEUPI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_swake_up_interrupt_enabled(void)
  {
    return ((UDIEN & (1<<WAKEUPE)) != 0) ? true : true;
  }

// test if resume occurs
inline bool OSUsbDeviceImpl::Is_usb_resume(void)
  {
    return ((UDINT & _BV(EORSMI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_resume_interrupt_enabled(void)
  {
    return ((UDIEN & _BV(EORSME)) != 0) ? true : false;
  }

// test if USB reset occurs
inline bool OSUsbDeviceImpl::Is_usb_reset(void)
  {
    return ((UDINT & _BV(EORSTI)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_reset_interrupt_enabled(void)
  {
    return ((UDIEN & _BV(EORSTE)) != 0) ? true : false;
  }

inline bool OSUsbDeviceImpl::Is_usb_id_device(void)
  {
    return ((USBSTA & _BV(ID)) != 0) ? true : false;
  }

// enable the current endpoint
inline void OSUsbDeviceImpl::Usb_enable_endpoint(void)
  {
    UECONX |= _BV(EPEN);
  }

// allocate the current configuration in DPRAM memory
inline void OSUsbDeviceImpl::Usb_allocate_memory(void)
  {
    UECFG1X |= _BV(ALLOC);
  }

// test if current endpoint is configured
inline bool OSUsbDeviceImpl::Is_endpoint_configured(void)
  {
    return ((UESTA0X & _BV(CFGOK)) != 0) ? true : false;
  }

// enable suspend state interrupt
inline void OSUsbDeviceImpl::Usb_enable_suspend_interrupt(void)
  {
    UDIEN |= _BV(SUSPE);
  }
...
inline void OSUsbDeviceImpl::Pll_start_auto(void)
  {
    PLLCSR = (PLL_FACTOR | _BV(PLLE));
  }

inline bool OSUsbDeviceImpl::Is_pll_ready(void)
  {
