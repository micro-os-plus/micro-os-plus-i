...
int DeviceCharacterUsb::implOpen()
  {
...
OSEvent_t DeviceCharacterUsb::implGetOpenEvent(void)
  {
    return (OSEvent_t)&m_opened;
  }

bool DeviceCharacterUsb::implIsConnected() const
  {
...
int DeviceCharacterUsb::implClose()
  {
...
bool DeviceCharacterUsb::implCanWrite(void)
  {
    return true;
  }

OSEvent_t DeviceCharacterUsb::implGetWriteEvent(void)
  {
    return (OSEvent_t)&m_txCounter;
  }

int DeviceCharacterUsb::implWriteByte(unsigned char b)
  {
    // if closed return -1
    if (!m_opened)
...
int DeviceCharacterUsb::implFlush(void)
  {
    // if closed return -1
    if (!m_opened)
      return OSReturn::OS_DISCONNECTED;
...
bool DeviceCharacterUsb::implCanRead()
  {
...
OSEvent_t DeviceCharacterUsb::implGetReadEvent(void)
  {
...
void DeviceCharacterUsb::specificCdcInterruptServiceRoutine(void)
  {
    if (UEINT & _BV(RX_EP))
      {
...
bool DeviceCharacterUsb::specificCdcProcessReadRequest(
...
bool DeviceCharacterUsb::specificCdcGetDescriptor(unsigned char type,
    unsigned char index)
  {
    switch (type)
      {
...
void DeviceCharacterUsb::cdcGetLineCoding(void)
  {
...
void DeviceCharacterUsb::cdcSetLineCoding(void)
  {
...
void DeviceCharacterUsb::cdcSetControlLineState()
  {
    unsigned short value;
...
void DeviceCharacterUsb::specificCdcEndpointInit(unsigned char __attribute__( ( unused ) ) conf_nb)
  {
    ...
    SIZE_32, TWO_BANKS, NYET_ENABLED);
