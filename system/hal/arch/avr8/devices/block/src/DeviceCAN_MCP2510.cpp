...
DeviceCAN_MCP2510::DeviceCAN_MCP2510(CANPacket *pRxBuf,
    ...
    OSDeviceCAN(pRxBuf, rxBufSize, rxHWM, rxLWM, pTxBuf, txBufSize, txHWM,
        txLWM)
{
...
DeviceCAN_MCP2510::~DeviceCAN_MCP2510()
{
  OSDeviceDebug::putDestructor_P(PSTR("DeviceCAN_MCP2510"), this);
}

void
DeviceCAN_MCP2510::implInit(unsigned char mode)
{
  ...
  _set_CANINTE_bits(
      DeviceMCP2510::ERRIE | DeviceMCP2510::RX1IE | DeviceMCP2510::RX0IE);
...
void
DeviceCAN_MCP2510::interruptServiceRoutine(void)
{
      ...
      if ((c & DeviceMCP2510::ERRIF) != 0)
        {
          ...
          if (((get_reg(DeviceMCP2510::CANSTAT) >> 5)
              == DeviceMCP2510::CAN_LISTEN)
              && ((e & DeviceMCP2510::RX0OVR) != 0))
            {
              ;
            }
          else
...
bool
DeviceCAN_MCP2510::implCanRead(void)
{
...
bool
DeviceCAN_MCP2510::implCanWrite(void)
{
  return true; // TODO:
}
...
int
DeviceCAN_MCP2510::implWritePacket(CANPacket *p)
{
  if (!m_txBuf.isFull())
    {
...
void
DeviceCAN_MCP2510::implTransmit(void)
{
  tx0_transmit();
}

extern "C" void INT5_vect(void) __attribute__((signal, naked));
...
void
DeviceCAN_MCP2510::put_reg(unsigned char r, unsigned char v)
{
  _put_reg(r, v);
}

unsigned char
DeviceCAN_MCP2510::get_reg(unsigned char r)
{
  unsigned char i;
...
void
DeviceCAN_MCP2510::clear_inte_bits(unsigned char b)
{
  _clear_CANINTE_bits(b);
}

void
DeviceCAN_MCP2510::clear_intf_bits(unsigned char b)
{
  _clear_CANINTF_bits(b);
}

unsigned char
DeviceCAN_MCP2510::get_ICOD(void)
{
  unsigned char i;
...
void
DeviceCAN_MCP2510::tx0_transmit(void)
{
  _tx0_transmit();
}

bool
DeviceCAN_MCP2510::tx0_isr(CANPacket *pc)
{
  if (m_txBuf.isEmpty())
    return false;
...
void
DeviceCAN_MCP2510::put_TX0(CANPacket *pc)
{
  unsigned char i, j;
  unsigned short id;
  unsigned char* p;
