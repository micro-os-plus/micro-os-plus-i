...
inline void DeviceLM74::clkInit(void)
  {
    OS_CONFIG_LM74_CLK_PORT_WRITE &= ~_BV(OS_CONFIG_LM74_CLK_BIT);
    OS_CONFIG_LM74_CLK_PORT_CONFIG |= _BV(OS_CONFIG_LM74_CLK_BIT);
  }
...
inline void DeviceLM74::dataIn(void)
  {
    OS_CONFIG_LM74_DATA_PORT_CONFIG &= ~_BV(OS_CONFIG_LM74_DATA_BIT);
  }
...
inline void DeviceLM74::dataHigh(void)
  {
    OS_CONFIG_LM74_DATA_PORT_WRITE |= _BV(OS_CONFIG_LM74_DATA_BIT);
  }
