...
OSUsbDeviceImpl::interruptGenServiceRoutine(void)
  {
    ...
    if (OSUsbDeviceImpl::Is_usb_reset() && OSUsbDeviceImpl::Is_reset_interrupt_enabled())
      {
...
//                                                  data_to_transfer, &pbuffer);
        ...
        while( !OSUsbDeviceImpl::Is_usb_tx_ready() ) ;     // Wait Endpoint ready...
 ...
 */
bool OSUsbDeviceImpl::usb_get_interface(void)
  {
#if TO_BE_PORTED
    OSUsbDeviceImpl::Usb_enable_stall_handshake();
    OSUsbDeviceImpl::Usb_ack_receive_setup();
