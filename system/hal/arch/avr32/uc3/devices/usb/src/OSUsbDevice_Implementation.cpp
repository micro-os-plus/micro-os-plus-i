...
extern void
USB_GEN_contextHandler(void) __attribute__((interrupt));

void
USB_GEN_contextHandler(void)
  {
...
extern void
USB_COM_contextHandler(void) __attribute__((interrupt));

void
USB_COM_contextHandler(void)
  {
    OSScheduler::ledActiveOn();
