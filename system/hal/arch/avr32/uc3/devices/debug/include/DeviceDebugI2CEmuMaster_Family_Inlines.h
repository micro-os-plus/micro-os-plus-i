...
inline void masterSclInit(void)
  {
    OS_GPIO_PORT_HIGH(OS_CONFIG_DEBUG_SCL_PORT, OS_CONFIG_DEBUG_SCL_BIT);
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SCL_PORT_CONFIG, OS_CONFIG_DEBUG_SCL_BIT, OS_CFV(GPIO_Mode_Out_OD, GPIO_Speed_50MHz));
  }
...
inline void masterSdaInit(void)
  {
    OS_GPIO_PORT_HIGH(OS_CONFIG_DEBUG_SDA_PORT, OS_CONFIG_DEBUG_SDA_BIT);
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SDA_PORT_CONFIG, OS_CONFIG_DEBUG_SDA_BIT, OS_CFV(GPIO_Mode_Out_OD, GPIO_Speed_50MHz));
  }
