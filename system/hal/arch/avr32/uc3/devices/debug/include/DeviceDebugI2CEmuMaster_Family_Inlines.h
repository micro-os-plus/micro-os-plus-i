...
inline void masterSclInit(void)
  {
    ...
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SCL_PORT_CONFIG, OS_CONFIG_DEBUG_SCL_BIT, 0);
  }
...
inline void masterSclLow(void)
  {
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SCL_PORT_CONFIG, OS_CONFIG_DEBUG_SCL_BIT, 1);
  }
...
inline void masterSdaInit(void)
  {
    ...
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SDA_PORT_CONFIG, OS_CONFIG_DEBUG_SDA_BIT, 0);
  }
...
inline void masterSdaLow(void)
  {
    OS_GPIO_PORT_CONFIG(OS_CONFIG_DEBUG_SDA_PORT_CONFIG, OS_CONFIG_DEBUG_SDA_BIT, 1);
  }
